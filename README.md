...
The 30-trial real-agent matrix is still blocked by missing Cursor authentication on the
remote benchmark host, so adoption, token, and p95 gates remain unproven release blockers.
